...
// public
Splitter.prototype.split = function (cssString, maxSelectors, compress) {

    var ast = this._parseCSS(cssString);
    this._totalSelectors = this._iterateRules(ast.stylesheet.rules, 0, true);

    return this._splitCSS(ast, maxSelectors, compress);
};
...
Splitter.prototype._splitCSS = function (ast, maxSelectors, compress) {
    return this._toPages(ast, maxSelectors)
      .map(function (page) {

        return css.stringify(page, {compress: compress});
